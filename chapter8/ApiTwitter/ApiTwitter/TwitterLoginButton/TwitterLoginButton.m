...
- (UIImage*)buttonImage {
  if (_isLoggedIn) {
    return [UIImage imageNamed:@"TwitterOAuth.bundle/images/LogoutNormal.png"];
  } else {
    return [UIImage imageNamed:@"TwitterOAuth.bundle/images/LoginNormal.png"];
  }
}
...
- (UIImage*)buttonHighlightedImage {
  if (_isLoggedIn) {
    return [UIImage imageNamed:@"TwitterOAuth.bundle/images/LogoutPressed.png"];
  } else {
    return [UIImage imageNamed:@"TwitterOAuth.bundle/images/LoginPressed.png"];
  }
}
